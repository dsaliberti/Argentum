...
public struct PicsumItem: Hashable, Decodable, Sendable, Identifiable {
  ...
  ///   - author: The name of the image's author
...
#if DEBUG
import Foundation
extension PicsumItem {
  public static let mock = PicsumItem(
    id: "0",
...
extension Array where Element == PicsumItem {
  public static let mock: [PicsumItem] = {
    ...
    do {
      return try decoder.decode([PicsumItem].self, from: jsonData)
    } catch {
